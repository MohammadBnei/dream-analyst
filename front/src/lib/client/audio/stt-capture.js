...
//
// Copied rather than imported from https://stt.bnei.dev/stt-capture.js on
// purpose: a cross-origin module import would make this page's microphone stop
// working whenever the STT service is down or its node reboots for gaming —
// turning a degraded feature into a broken one. ADR-0044 accepts STT being
// unavailable; it does not accept that taking the editor with it.
//
// Re-copy when ukubi-stt changes it. The drift is the accepted cost of there
// being no npm registry in this cluster.
