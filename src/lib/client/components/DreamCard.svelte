...
<li class="list-row" transition:fade>
	...
	<!-- View Details Button -->
	<a href={`/dreams/${dream.id}`} class="btn btn-square btn-ghost tooltip tooltip-left" data-tip={m.view_details_button()}>
	...
	<button class="btn btn-square btn-ghost tooltip tooltip-left" data-tip={showRawText ? 'Hide dream text' : 'Show dream text'} onclick={() => (showRawText = !showRawText)}>
		{#if showRawText}
